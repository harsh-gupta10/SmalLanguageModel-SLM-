...
def collect_sanskrit_data():
    ...
    # Target 10% of 3B tokens = 300M tokens. Approx 1.5 GB of text.
    # We will aim for this as the minimum.
    target_size_gb = 1.5
    ...
    try:
        # Load the 'san' subset from the Sangraha dataset
        dataset = load_dataset("ai4bharat/sangraha", name="san", split="train", streaming=True)
